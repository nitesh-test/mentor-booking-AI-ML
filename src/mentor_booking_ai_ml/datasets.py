...
def generate_dataset(output_dir: Optional[Path] = None) -> Path:
    """Generate example quadratic question dataset.

    Args:
        output_dir: Directory in which to place generated CSV files. If not
            provided, a ``data`` directory will be created at the project root.
